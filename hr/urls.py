...
urlpatterns = [
    path('employees/', cache_page(60*1)(views.EmployeeListView.as_view()), name='employee_list'),
    path('employees/', cache_page(60*3)(views.EmployeeProfileView.as_view()), name='employee_list'),
