...
urlpatterns = [
    path('employees/', cache_page(5)(views.EmployeeListView.as_view()), name='employee_list'),
    ...
    path('employees/profile/<int:pk>/', cache_page(60*4)(views.EmployeeProfileView.as_view()), name='employee_profile'),
